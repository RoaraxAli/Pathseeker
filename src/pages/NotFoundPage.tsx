...
export const NotFoundPage: React.FC = () => {
  return (
    <main className="relative min-h-[100svh] w-full overflow-x-hidden overflow-y-auto bg-black text-white selection:bg-white/20 selection:text-white flex flex-col items-center justify-center">
      {/* Background Video */}
      <video
        autoPlay
        loop
      ...
      <header
        aria-label="LGPSM"
        className="absolute z-10 top-[32px] sm:top-[80px] left-1/2 -translate-x-1/2 flex items-center justify-center scale-75 sm:scale-100 origin-top pointer-events-auto"
      ...
      >
        ...
        <svg
          ...
          fill="none"
          className="h-[40px] w-auto ml-[14px] shrink-0"
          aria-hidden="true"
        >
          <path
      ...
      <div
        className="absolute z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center text-center w-[min(100%-40px,360px)] sm:w-[483px] gap-[28px] sm:gap-[44px] pointer-events-auto"
      >
        {/* 404 Heading */}
        <h1
          style={{
          ...
          className="text-[clamp(140px,52vw,200px)] sm:text-[295.751px] tracking-[-0.09em] sm:tracking-[-24.6459px] pb-2 sm:pb-4 select-none"
        >
          404
        </h1>

        {/* Solid White Divider */}
        <div className="w-full sm:w-[425px] h-[1px] bg-white shrink-0" />
        ...
        <p
          ...
          className="text-[clamp(16px,4.5vw,20px)] sm:text-[24px] tracking-[-1.3px] sm:tracking-[-2px] text-white max-w-full"
        >
        ...
        <div className="pt-2">
          <Link
            to="/"
            className="liquid-glass-strong rounded-full px-6 py-3 flex items-center gap-2 text-sm font-body font-medium text-white hover:bg-white/10 active:scale-95 transition-all shadow-lg group"
          >
